...
public class AppDbSeed
{
    public AppDbSeed(ModelBuilder builder)
    {
        List<Banca> bancas = new() {
            ...
            new Banca { Id = 1, Nome = "Nível Medio", Tipo = "medio" },
            new Banca { Id = 2, Nome = "Nível Superior", Tipo = "superior" },
...
#region Populate UserRole - Usuário com Perfil
        ...
        List<Questionario> questionario1 = new List<Questionario>()
        {
            new Questionario {
                Id = 1,
                Nome= "Questionário",
        ...
        builder.Entity<Questionario>().HasData(questionario1);
             
        List<Questionario> questionario2 = new List<Questionario>()
        {
            new Questionario {
                Id = 2,
                Nome= "Questionário",
        ...
        builder.Entity<Questionario>().HasData(questionario2);
        ...
        List<Questoes> questoes = new List<Questoes>
        {
            ...
            {
                Id = 4,
                Questao = "(Avança SP) Indique a alternativa que apresenta a implementação do .NET mais adequada para criação de aplicativos multiplataforma, que executam em Windows, Linux e macOS.",
